...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kit Junino EVA com moldes para Festa Junina e atividades com crianças." },
    ...
    links: [
      ...
      { rel: "dns-prefetch", href: "https://fast.wistia.com" },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              window.pixelId = "6a038badaaa42828a282dffd";
